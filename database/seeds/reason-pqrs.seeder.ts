...
import { ReasonPqrsEntity } from '../../src/common/entities/reason-pqrs.entity';

export class ReasonPqrsSeeder implements Seeder {
  async run(dataSource: DataSource): Promise<void> {
    const repository = dataSource.getRepository(ReasonPqrsEntity);
